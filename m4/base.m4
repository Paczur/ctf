...
define(`foreach', `pushdef(`$1')_$0(`$1',
  (dquote(dquote_elt$2)), `$3')popdef(`$1')')dnl
define(`_arg1', `$1')dnl
define(`_foreach', `ifelse(`$2', `(`')', `',
  `define(`$1', _arg1$2)$3`'$0(`$1', (dquote(shift$2)), `$3')')')dnl
dnl
define(`PRIMITIVE_TYPES', ``char', `int', `uint', `ptr'')dnl
define(`CMPS', ``eq', `neq', `lt', `gt', `lte', `gte'')dnl
